...
| [`paginate_relationship_with`](#graphql-paginate_relationship_with){: #graphql-paginate_relationship_with } | `keyword` | `[]` | A keyword list indicating which kind of pagination should be used for each `has_many` and `many_to_many` relationships, e.g. `related_things: :keyset, other_related_things: :offset`. Valid pagination values are `nil`, `:none`, `:offset`, `:keyset` and `:relay`. Relay relationships may also use keyword configuration, e.g. `related_things: [strategy: :relay, name: :related_things_connection, edge: [name: :related_things_edge, fields: [:position]]]`. For `many_to_many` relationships, `edge: [fields: fields]` exposes the listed join resource attributes, aggregates, calculations, or relationships on the relay edge regardless of whether they are public. Edge fields are nullable by default. |
...
| [`filter_handlers`](#graphql-filter_handlers){: #graphql-filter_handlers } | `keyword` |  | Per-field filter handlers that customize GraphQL filter input types and runtime filter behavior. Each entry maps a filterable field to a handler MFA and GraphQL input type. The handler receives the filter operand and a context map, and returns an Ash expression used in the filter. Attributes and public calculations may be handled. A handler takes precedence over the field's normal filtering, so a calculation that is not filterable on its own (for example a non-expression calculation, or one marked `filterable? false`) still gets a filter input field when a handler is configured. This makes it possible to expose a logical field in GraphQL while filtering it through a different, private representation. Example:     filter_handlers [       id: [         type: :id,         handler: {AshGraphql.Graphql.FilterHandlers, :relay_id, [:my_type]},         description: "Filter by Relay global ID"       ],       card_number: [         type: :string,         handler: {MyApp.FilterHandlers, :blind_index, [:card_number_hash]}       ]     ] |
...
| [`labels`](#graphql-queries-get-labels){: #graphql-queries-get-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this query from schemas with matching labels. |
...
| [`labels`](#graphql-queries-read_one-labels){: #graphql-queries-read_one-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this query from schemas with matching labels. |
...
| [`labels`](#graphql-queries-list-labels){: #graphql-queries-list-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this query from schemas with matching labels. |
...
| [`labels`](#graphql-queries-action-labels){: #graphql-queries-action-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this action from schemas with matching labels. |
...
| [`labels`](#graphql-queries-group-get-labels){: #graphql-queries-group-get-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this query from schemas with matching labels. |
...
| [`labels`](#graphql-queries-group-read_one-labels){: #graphql-queries-group-read_one-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this query from schemas with matching labels. |
...
| [`labels`](#graphql-queries-group-list-labels){: #graphql-queries-group-list-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this query from schemas with matching labels. |
...
| [`labels`](#graphql-queries-group-action-labels){: #graphql-queries-group-action-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this action from schemas with matching labels. |
...
| [`labels`](#graphql-mutations-group-create-labels){: #graphql-mutations-group-create-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this mutation from schemas with matching labels. |
| [`error_location`](#graphql-mutations-group-create-error_location){: #graphql-mutations-group-create-error_location } | `:in_result \| :top_level` | `:in_result` | If the result should have an `errors` and a `result` key, or if errors should be shown in the top level errors key |
...
| [`labels`](#graphql-mutations-group-update-labels){: #graphql-mutations-group-update-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this mutation from schemas with matching labels. |
| [`error_location`](#graphql-mutations-group-update-error_location){: #graphql-mutations-group-update-error_location } | `:in_result \| :top_level` | `:in_result` | If the result should have an `errors` and a `result` key, or if errors should be shown in the top level errors key |
...
| [`labels`](#graphql-mutations-group-destroy-labels){: #graphql-mutations-group-destroy-labels } | `atom \| list(atom)` | `[]` | Labels used to include or exclude this mutation from schemas with matching labels. |
| [`error_location`](#graphql-mutations-group-destroy-error_location){: #graphql-mutations-group-destroy-error_location } | `:in_result \| :top_level` | `:in_result` | If the result should have an `errors` and a `result` key, or if errors should be shown in the top level errors key |
